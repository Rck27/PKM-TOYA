...
#include "myFont.h"
    ...
    const char availableChars[] = {'1', '2', '3', '4', '5', '6', '7', '8', '9', '0'};
...
void generateRandomSequence(char sequence[], int length, const char availableChars[], int availableLength) {
...
void simonSaysGame(char input) {
  ...
  if (!gameStarted) {
    ...
    generateRandomSequence(sequence, 5, availableChars, availableLength);
